let notificationStudent = false; /*if it is false the notification is hidden*/
const notificationss = document.getElementById("notifications");
...
function EnrollRequestAccept( fromId , toId ){
    ...
    /*httpreq.open( "POST" , "/EduClick_war_exploded/student/AcceptEnrollRequest" , true );
