...
public class DBBackup implements ServletContextListener {
    ...
    final private String database = "educlickdb";
                    ...
                    while( true ){
                        ...
                        if ( fixedAfterTwelveAm.getHour() <= nowTime.getHour() && fixedBeforeSixAm.getHour() > nowTime.getHour() ){
                            ...
                            if ( backupStatus ){
                                ...
                                String path = "D:\\UCSC\\2nd year\\1st sem\\2.project work\\EduClick\\DbBackup\\eduClickDbBackup" + localDate.getYear() + localDate.getMonth() + localDate.getDayOfMonth() + ".sql";
                            ...
                            if ( !backupStatus )backupStatus = true;
